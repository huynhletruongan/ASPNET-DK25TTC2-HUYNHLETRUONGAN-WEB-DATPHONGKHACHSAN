    ...
    public class NhanViensController : BaseController
    {
        ...
        public ActionResult Search(string maNV = "", string tenNV = "", string gioiTinh = "", string diaChi = "", string email = "", string sdt = "", string idNhom = "")
        {
            ...
            var nhanViens = db.NhanViens
                .Where(x => string.IsNullOrEmpty(maNV) || x.maNV.Contains(maNV))
                .Where(x => string.IsNullOrEmpty(tenNV) || x.tenNV.Contains(tenNV))
                ...
                .Where(x => string.IsNullOrEmpty(idNhom) || x.QuanTris.Any(q => q.IDNhom == idNhom))
                .ToList();
